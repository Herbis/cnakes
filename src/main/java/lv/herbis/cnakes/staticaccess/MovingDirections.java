        ...
        switch (player) {
            case PLAYER_1:
                if (MovingDirections.P1_DIRECTION_Q == null) {
                    MovingDirections.P1_DIRECTION_Q = new LinkedList<>();
                } else {
            ...
            case PLAYER_2:
                if (MovingDirections.P2_DIRECTION_Q == null) {
                    MovingDirections.P2_DIRECTION_Q = new LinkedList<>();
                } else {
            ...
            case PLAYER_3:
                if (MovingDirections.P3_DIRECTION_Q == null) {
                    MovingDirections.P3_DIRECTION_Q = new LinkedList<>();
                } else {
            ...
            case PLAYER_4:
                if (MovingDirections.P4_DIRECTION_Q == null) {
                    MovingDirections.P4_DIRECTION_Q = new LinkedList<>();
                } else {
            ...
            case PLAYER_5:
                if (MovingDirections.P5_DIRECTION_Q == null) {
                    MovingDirections.P5_DIRECTION_Q = new LinkedList<>();
                } else {
            ...
            case PLAYER_6:
                if (MovingDirections.P6_DIRECTION_Q == null) {
                    MovingDirections.P6_DIRECTION_Q = new LinkedList<>();
                } else {
            ...
            case PLAYER_7:
                if (MovingDirections.P7_DIRECTION_Q == null) {
                    MovingDirections.P7_DIRECTION_Q = new LinkedList<>();
                } else {
            ...
            case PLAYER_8:
                if (MovingDirections.P8_DIRECTION_Q == null) {
                    MovingDirections.P8_DIRECTION_Q = new LinkedList<>();
                } else {
